...
<table class="shop_table woocommerce-checkout-review-order-table">
	...
	<tbody>
		<?php
            ...
            <?php if ($personalisation_text) : ?>
                <tr>
                    <td class="product-customisation">
                        <small>Personalised Text : <?php echo $personalisation_text ?></small>
                    </td>
                    <td></td>
                </tr>
            <?php endif; ?>
	...
	<tfoot>
		...
		<tr class="order-total">
			...
			<th><?php _e( 'Shipping cost', 'woocommerce' ); ?></th>
