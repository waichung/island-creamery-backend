...
$context['cart_items'] = [];
$context['return_to_shop'] = esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) );
...
$context['personalisation_text'] = $wc_session->get('personalisation_text');
$context['personalisation_enabled'] = $wc_session->get('personalisation_enabled');

Timber::render('pages/cart.twig', $context); ?>
